...
namespace AssetExtractor
{
    internal static class Exporter
    {
        ...
        {
            var convert = animationList != null
                ? new ModelConverter(gameObject, ImageFormat.Png, animationList.Select(x => (AnimationClip)x.Asset).ToArray())
                : new ModelConverter(gameObject, ImageFormat.Png);
        ...
        public static void ExportGameObjectMerge(List<GameObject> gameObject, string exportPath, List<AssetItem> animationList = null)
        {
            ...
            var convert = animationList != null
                ? new ModelConverter(rootName, gameObject, ImageFormat.Png, animationList.Select(x => (AnimationClip)x.Asset).ToArray())
                : new ModelConverter(rootName, gameObject, ImageFormat.Png);
            ExportFbx(convert, exportPath);
        }
